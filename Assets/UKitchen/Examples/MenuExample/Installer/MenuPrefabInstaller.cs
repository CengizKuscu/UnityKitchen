...
namespace UKitchen.Examples.MenuExample.Installer
{
    [CreateAssetMenu(fileName = "MenuPrefabInstaller", menuName = "UnityKitchen/Installers/MenuExample/MenuPrefabInstaller")]
